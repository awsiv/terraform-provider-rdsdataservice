...
import (
	...
	"github.com/awsiv/terraform-provider-dataapi/dataapi/internal/keyvaluetags"
	"github.com/awsiv/terraform-provider-dataapi/dataapi/internal/mutexkv"
...
func Provider() *schema.Provider {
	...
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"dataapi_postgres_database": resourceAwsRdsdataservicePostgresDatabase(),
			"dataapi_postgres_role":     resourceAwsRdsdataservicePostgresRole(),
		},
	}
